...
import com.imoxion.sensems.server.nio.smtp.handler.ImSmtpServerHandler;
...
public class ImSmtpInitializier extends ChannelInitializer<SocketChannel> {
...
//        cp.addLast("decoder", new StringDecoder());
        ...
        cp.addLast("basehandler", new ImSmtpServerHandler(new ImSmtpSession(sslContext)));
