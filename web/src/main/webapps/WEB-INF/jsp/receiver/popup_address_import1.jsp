...
<div class="popup_title over_text">
    <div>
        <h3 class="title"><spring:message code="E0416" text="주소록 가져오기 1단계"/></h3>
    </div>
</div>
...
<div class="section">
    ...
    <div class="article content">
        ...
        <div class="composer_area" >
            <form name="importForm" id="importForm" method="post" action="/receiver/address/doImport2.do?${_csrf.parameterName}=${_csrf.token}" enctype="multipart/form-data" accept-charset="UTF-8">
...
<div class="btn_div ">
    <button class="btn1" href="javascript:;" onclick="addressList.addrSampleDownload();"><spring:message code="E0418" text="샘플 다운로드"/></button>
    <button class="btn2" href="javascript:;" onclick="addressList.doFileUp()"><spring:message code="E0419" text="다음"/></button>
