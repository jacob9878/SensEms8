...
<div class="receivergroup_add">
    ...
    <div class="title_box fixed">
        <div class="article top_area">
            <div class="title">
                ...
                <p><spring:message code="E0173" text="수신그룹을 추가할 수 있습니다."/></p>
            </div>
        </div>
    </div>
    <!-- top area end -->
    ...
    <div class="content_top fixed">
        <ul class="content_top_btn">
            <li><a class="btn1" href="javascript:;" onclick="receiverSave.save('add')"><spring:message code="E0029" text="추가"/></a></li>
    ...
    <div class="section pd_l30">
        ...
        <div class="article content">
            <form:form method="post" name="ReceiverGroupForm" id="ReceiverGroupForm" modelAttribute="ReceiverGroupForm" action="add.do">
                ...
                <div class="composer_area">
                    <table width="100%" border="0" cellpadding="0" cellspacing="1" >
                        ...
                        <tr class="table_database">
                            ...
                            <td>
                                <form:select path="dbkey" onchange="removecontent(this)">
                    ...
                    <table  class="queryBox" border="0"  cellpadding="0" cellspacing="0" >
                        ...
                        <tr class="queryBox_btn">
                            <td colspan="2" align="center">
                                <button type="button" id="createQuery" class="btn1 tbl_ft_btn" onclick="receiverList.makeQuery()"><spring:message code="E0186" text="쿼리 생성하기"/><span class="add_query_icon"></span></button>
                            </td>
                        </tr>
                        </tbody>
                    </table>
        ...
        <div class="popup" id="addFieldPopup" style="display: none">
            <div class="popup_content" style="height:350px;">
                ...
                <div class="popup_body_wrap" style="height:300px;">
            ...
            <div class="popup_content">
                ...
                <div class="popup_body_wrap">
                    <div class="popup_body">
                        ...
                        <table id="same_table" style="display:inline-table">
                            <colgroup>
                                <col style="width: 170px;">
                                <col style="width: auto;">
                            </colgroup>
