...
<div class="popup_title over_text">
    <div>
        <h3 class="title"><spring:message code="E0719" text="수신거부목록 가져오기 2단계"/></h3>
    </div>
</div>
                ...
                <table  width ="100%" height="auto" >
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="radio" name="div" value="0" onclick="reject_list.doPreview();" checked/><spring:message code="E0421" text="콤마(,)로 구분"/>
                                <input type="radio" name="div" value="1" onclick="reject_list.doPreview();"/><spring:message code="E0422" text="세미콜론(;)으로 구분"/>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <span><input type="checkbox" name="isheader" value="true" onclick="reject_list.doPreview();"/><spring:message code="E0425" text='첫행이 헤더'/></span>
                            </td>
                        </tr>
                        <tr>
                            <th>
...
<div class="pop_footer">
    <div class="btn_div">
        <button class="btn2" href="javascript:;" onclick="reject_list.doFileSubmit()"><spring:message code="E0419" text="다음"/></button>
